    ...
    <ui:soy moduleKey="'com.atlassian.auiplugin:soy'" template="'aui.page.pagePanel'">
        <ui:param name="'content'">
            ...
            <page:applyDecorator id="edit-entity" name="auiform">
                ...
                <page:param name="cancelLinkURI">ConfigurePortalPages.jspa</page:param>
                ...
                <page:applyDecorator name="auifieldgroup">
                    <aui:textfield id="dashboard-name" label="text('common.words.name')" name="'portalPageName'" theme="'aui'">
                        <aui:param name="'mandatory'">true</aui:param>
                    </aui:textfield>
                </page:applyDecorator>

                <page:applyDecorator name="auifieldgroup">
                    <aui:textarea id="dashboard-description" label="text('common.concepts.description')" name="'portalPageDescription'" rows="3" theme="'aui'" />
                </page:applyDecorator>

                <page:applyDecorator name="auifieldgroup">
                    <aui:select id="dashboard-start-from" label="text('portal.startfrom')" name="'clonePageId'" list="cloneTargetDashboardPages" listKey="'id'" listValue="'name'" theme="'aui'">
