            ...
            <page:param name="pretitle">
                <ww:if test='/fieldLocked == false'>
                    <div class="toolbar">
                        ...
                        <a id="delete_<ww:property value="id" />" class="trigger-dialog" href="<ww:url page="/secure/admin/ConfigureCustomField!delete.jspa?"><ww:param name="'customFieldId'" value="/customFieldId"/><ww:param name="'fieldId'" value="./id" /></ww:url>" title="<ww:text name="'admin.issuefields.customfields.delete.scheme'"/>"><span class="icon-default aui-icon aui-icon-small aui-iconfont-delete"></span></a>
                    </div>
                </ww:if>
            </page:param>
