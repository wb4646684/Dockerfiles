        ...
        <ui:param name="'content'">
            ...
            <ul>
                ...
                <li>
                    ...
                    <p>
                        <ww:text name="'showtimetrackinghelp.timetracking.options.note'">
                            <ww:param name="'value0'"><strong></ww:param>
                            <ww:param name="'value1'"></strong></ww:param>
                            <ww:param name="'value2'"><ww:text name="'showtimetrackinghelp.timetracking.originalestimate.title'"/></ww:param>
                            <ww:param name="'value3'"><ww:text name="'showtimetrackinghelp.remainingestimate.title'"/></ww:param>
                            <ww:param name="'value4'"><ww:text name="'admin.globalsettings.timetracking.legacy.mode.fieldname'"/></ww:param>
                        </ww:text>
                    </p>
                </li>
                <li>
