...
define("jira/admin/application/approleeditor", ["jquery", "underscore", "backbone", "marionette", "jira/skate", "jira/admin/application/grouppicker", "wrm/data", "aui/inline-dialog2", "jira/admin/application/application-role-labels"], function ($, _, Backbone, Marionette, skate, GroupPicker, wrmData) {
    "use strict";
