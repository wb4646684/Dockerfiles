    ...
    var IssuePicker = MultiSelect.extend({
        ...
        _renders: {
            popupLink: function popupLink() {
                var link = $("<div class='issue-picker-popup' />").attr({ title: this.options.popupLinkMessage });
                var icon = $('<span class="aui-icon aui-icon-small aui-iconfont-add"></span>').text(this.options.popupLinkMessage);
