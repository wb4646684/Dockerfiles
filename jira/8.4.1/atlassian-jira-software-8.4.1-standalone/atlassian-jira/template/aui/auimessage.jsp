...
<ww:declare id="varTypeClass" value="@varType"><ww:if test=". && . != ''"> aui-message-<ww:property value="." /></ww:if></ww:declare>
...
<div<ww:property value="@varId" escape="false" /> class="aui-message<ww:property value="@varTypeClass" /><ww:property value="@varCssClass" />"><ww:property value="@varHelp" escape="false" /><ww:property value="@varTitle" escape="false" /><ww:property value="parameters['messageHtml']" escape="false" /></div>
